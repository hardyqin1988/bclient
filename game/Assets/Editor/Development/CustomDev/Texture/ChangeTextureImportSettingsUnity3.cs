...
public class ChangeTextureImportSettingsUnity3 : ScriptableObject {
    ...
    [MenuItem ("Development/Texture/Change Texture Format/Auto Compressed")]
    ...
    [MenuItem ("Development/Texture/Change Texture Format/Auto 16bit")]
    static void ChangeTextureFormat_Auto16Bit() { 
        SelectedChangeTextureFormatSettings(TextureImporterFormat.Automatic16bit);
    }

    [MenuItem ("Development/Texture/Change Texture Format/Auto Truecolor")]
    ...
    [MenuItem ("Development/Texture/Change Texture Size/Change Max Texture Size/32")]
    static void ChangeTextureSize_32() { 
        SelectedChangeMaxTextureSize(32);
    }
    
    [MenuItem ("Development/Texture/Change Texture Size/Change Max Texture Size/64")]
    static void ChangeTextureSize_64() { 
        SelectedChangeMaxTextureSize(64);
    }
    
    [MenuItem ("Development/Texture/Change Texture Size/Change Max Texture Size/128")]
    static void ChangeTextureSize_128() { 
        SelectedChangeMaxTextureSize(128);
    }
    
    [MenuItem ("Development/Texture/Change Texture Size/Change Max Texture Size/256")]
    static void ChangeTextureSize_256() { 
        SelectedChangeMaxTextureSize(256);
    }
    
    [MenuItem ("Development/Texture/Change Texture Size/Change Max Texture Size/512")]
    static void ChangeTextureSize_512() { 
        SelectedChangeMaxTextureSize(512);
    }
    
    [MenuItem ("Development/Texture/Change Texture Size/Change Max Texture Size/1024")]
    static void ChangeTextureSize_1024() { 
        SelectedChangeMaxTextureSize(1024);
    }
    
    [MenuItem ("Development/Texture/Change Texture Size/Change Max Texture Size/2048")]
    ...
    [MenuItem ("Development/Texture/Change MipMap/Enable MipMap")]
    static void ChangeMipMap_On() { 
        SelectedChangeMimMap(true);
    }
    
    [MenuItem ("Development/Texture/Change MipMap/Disable MipMap")]
    ...
    [MenuItem ("Development/Texture/Change Is Readable/Enable")]
    static void ChangeIsReadable_Yes() { 
        SelectedChangeIsReadable(true);
    }
 
    [MenuItem ("Development/Texture/Change Is Readable/Disable")]
