...
public class Installer : EditorWindow
	...
	const string 
		...
		PLAYMAKER_ADD_ON_PATH 		= "Assets/Plugins/3rdParty/Control-Freak-2/Add-Ons/CF2-Playmaker.unitypackage",
		UFE_ADD_ON_PATH 				= "Assets/Plugins/3rdParty/Control-Freak-2/Add-Ons/CF2-UFE.unitypackage",
		UFE_HACKY_ADD_ON_PATH 		= "Assets/Plugins/3rdParty/Control-Freak-2/Add-Ons/CF2-UFE-Hack.unitypackage",
		UFPS_ADD_ON_PATH 				= "Assets/Plugins/3rdParty/Control-Freak-2/Add-Ons/CF2-UFPS.unitypackage",
		UNITZ_UNET_ADD_ON_PATH		= "Assets/Plugins/3rdParty/Control-Freak-2/Add-Ons/CF2-UnitZ-UNet.unitypackage",
		//OPSIVE_TPC_ADD_ON_PATH 		= "Assets/Plugins/3rdParty/Control-Freak-2/Add-Ons/CF2-Opsive-TPC.unitypackage",	
		OPSIVE_TPC_DL_URL				= "http://opsive.com/assets/ThirdPersonController/integrations.php",
		CF1_MIGRATION_ADD_ON_PATH	= "Assets/Plugins/3rdParty/Control-Freak-2/Add-Ons/CF2-CF1-Migration-Tools.unitypackage";
